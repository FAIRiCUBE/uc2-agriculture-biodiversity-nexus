...
# Load environment from a file (keep it safe and not in git!)
# The file should at least have the following entries:
...
# url to the rasdaman service handling WCS requests
base_wcs_url = rasdaman_endpoint + "?service=WCS&version=2.1.0"
logger.info(base_wcs_url)
