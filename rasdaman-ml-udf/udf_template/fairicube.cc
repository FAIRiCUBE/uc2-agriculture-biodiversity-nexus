...
const auto torchscript_model{"/home/rknapen/rastorch_proof_of_concept/pytorch_trained_models/rvo_crops_segnet_224x224x28_77classes_100epochs_model_full_traced.pt"s};
...
std::vector<float> getNormalizedVector(MyBaseType *arrayData, size_t arraySize){
    ...
    // Go through each band and normalize each band value with the max per band
    // Band 0
